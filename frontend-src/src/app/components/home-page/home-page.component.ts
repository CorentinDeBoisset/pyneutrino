...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, TimeFromNowPipe],
  templateUrl: './home-page.component.html',
  styleUrl: './home-page.component.scss'
})
export class HomePageComponent implements OnInit {
  conversations: Array<Conversation>;
  conversationFetchError: string | null = null;
  ...
  ngOnInit(): void {
   const req = this.httpClient.get<Array<Conversation>>("/api/messaging/conversation/own")
  ...
  newConversationSubmit(e: SubmitEvent) {
    ...
    const req = this.httpClient.post<Conversation>("/api/messaging/conversation/new", null)
